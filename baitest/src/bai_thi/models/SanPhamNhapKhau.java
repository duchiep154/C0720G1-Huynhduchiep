...
public class SanPhamNhapKhau extends SanPham {
    ...
    public SanPhamNhapKhau(int idSP, String maSP, String tenSP, String giaSP, String soLuongSP, String hangSX, String giaNhapKhau, String tinhNhapKhau, String thueNhapKhau) {
    ...
    public String hienThiThongTin() {
        return idSP+","+maSP+","+tenSP+","+giaSP+","+soLuongSP+","+hangSX+","+giaNhapKhau+","+tinhNhapKhau+","+thueNhapKhau;
    }
