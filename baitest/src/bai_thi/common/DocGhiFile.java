        ...
        if (file.isFile()) {
            ...
            try {
                ...
                while ((dong = bufferedReader.readLine()) != null) {
                    ...
                    sanPhamXuatKhau = new SanPhamXuatKhau(Integer.parseInt(mang[0]), mang[1], mang[2], mang[3], mang[4],mang[5],mang[6],mang[7]);
    ...
    public static List<SanPhamNhapKhau> docFileNK(){
        ...
        if (file.isFile()) {
            ...
            try {
                ...
                while ((dong = bufferedReader.readLine()) != null) {
                    mang = dong.split(DAU_PHAY);
                    sanPhamNhapKhau = new SanPhamNhapKhau(Integer.parseInt(mang[0]), mang[1], mang[2], mang[3], mang[4],mang[5],mang[6],mang[7],mang[8]);
