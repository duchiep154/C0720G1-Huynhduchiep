...
import bai_thi.common.DocGhiFile;
import bai_thi.models.SanPhamNhapKhau;
import bai_thi.models.SanPhamXuatKhau;
import bai_thi.validate.KiemTra;


import models.SinhVien;
import validate.NotFoundDirectoryException;
...
public class MenuChinh {
    ...
    private static void hienThiSanPham() {
        ...
        do {
            System.out.println("Thêm sản Phẩm vui lòng chọn theo chức năng\n" +
                    "1.hien thi sản phẩm nhập khẩu\n" +
                    "2. hien thi sản phẩm xuất khẩu\n" +
                    "3.quay lai menu chinh");
            System.out.print("Chọn chức năng: ");
            String chonMenu = input.nextLine();
            if (KiemTra.kiemTraSoNguyen(chonMenu)) {
    ...
    private static void hienthiSPXuatKhau() {
        ...
        if (danhSachXK.isEmpty()) System.out.println("Chưa có thông tin giao vien nào");
        else {
    ...
    private static void hienthiSPNhapKhau() {
        ...
        if (danhSachNK.isEmpty()) System.out.println("Chưa có thông tin giao vien nào");
        else {
            System.out.println("Danh sách giao vien :");
            int bienDem = 0;
            for (SanPhamNhapKhau element : danhSachNK) {
    ...
    private static void themSPNhapKhau() {
        ...
        SanPhamNhapKhau sanPhamNhapKhau=new SanPhamNhapKhau(idSP,maSP,tenSp,giaSP,soLuongSP,hangSX,giaNhapKhau,tinhNhapKhau,thueNhapKhau);
